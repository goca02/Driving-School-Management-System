 ...
 * @author Goca
 */
public class FormPretragaUcenika extends javax.swing.JDialog {

    public FormPretragaUcenika(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga ucenika");
        TableModelUcenici model = new TableModelUcenici();
        Thread th = new Thread(model);
        th.start();
        tblUcenici.setModel(model);
    }
    
    public FormPretragaUcenika() {
    initComponents();               
    setLocationRelativeTo(null);
        setTitle("Pretraga ucenika");
        TableModelUcenici model = new TableModelUcenici();
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji ucenika");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        TableModelUcenici tm = (TableModelUcenici) tblUcenici.getModel();
        tm.setParametar(param);
    }//GEN-LAST:event_txtPretragaKeyReleased

    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed

        int row = tblUcenici.getSelectedRow();

        if (row >= 0) {
            Ucenik u = ((TableModelUcenici) tblUcenici.getModel()).getSelectedUcenik(row);
            new FormDetaljiUcenika(this, true, u).setVisible(true);
        }
