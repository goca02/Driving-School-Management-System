 ...
 * @author Goca
 */
public class FormPretragaPlanaCasa extends javax.swing.JDialog {

   
    public FormPretragaPlanaCasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga plana casa");
        TableModelPlanoviCasa model = new TableModelPlanoviCasa();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pretraga (opis i lokacija):");
        ...
        btnDetalji.setText("Detalji plan casa");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        TableModelPlanoviCasa tm = (TableModelPlanoviCasa) tblPlanovi.getModel();
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            PlanCasa pc = ((TableModelPlanoviCasa) tblPlanovi.getModel()).getSelectedPlanCasa(row);
            new FormDetaljiPlanaCasa(this, true, pc).setVisible(true);
        }
